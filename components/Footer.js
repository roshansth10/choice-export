      ...
      <div className="container-custom relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 mb-8 lg:mb-12">
          <div className="lg:col-span-1">
            <a
              href="/"
              className="flex items-center justify-center lg:justify-start mb-4 hover:opacity-80 transition-opacity"
            >
              <img
                src="/img/1logo.png"
            ...
            <p className="text-gray-400 text-sm mb-4 sm:mb-6">
              Your trusted partner for world-class international shipping and
              logistics solutions from Nepal to global destinations.
            </p>
            <div className="flex space-x-3">
              <a
                ...
                className="w-10 h-10 rounded-lg bg-gray-800 hover:bg-primary-600 text-white flex items-center justify-center transition-colors text-lg"
              >
            ...
            <ul className="space-y-2 sm:space-y-3">
              {quickLinks.map((link, index) => (
                <li key={index}>
                  ...
                  >
                    <i
                      className={`${link.icon} text-primary-500 mr-2 sm:mr-3 flex-shrink-0 group-hover:translate-x-1 transition-transform`}
                    ></i>
                    {link.name}
                  </a>
                </li>
            ...
            <ul className="space-y-2 sm:space-y-3 text-gray-400 mb-6 sm:mb-8 text-sm">
              ...
              <li className="flex items-center">
                ...
                <span className="truncate">
                  choiceinternationalexport@gmail.com
                </span>
              </li>
            </ul>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-gray-400 text-xs sm:text-sm gap-4">
          <p className="text-center md:text-left">
            &copy; {new Date().getFullYear()} Choice International Export. All
            rights reserved.
          </p>
